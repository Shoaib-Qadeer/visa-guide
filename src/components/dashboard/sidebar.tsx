...
const items = [
  ...
  { href: "/dashboard/steps", label: "Visa Steps", icon: ListIcon },
  { href: "/dashboard/documents", label: "Documents", icon: FileIcon },
  { href: "/dashboard/timeline", label: "Timeline", icon: ClockIcon },
  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-30 hidden w-64 flex-col border-r border-slate-200 bg-white transition-colors dark:border-slate-800 dark:bg-slate-900 lg:flex">
      <div className="flex h-16 items-center gap-2 border-b border-slate-200 px-6 dark:border-slate-800">
        <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-brand-500 to-brand-700 text-white shadow-sm shadow-brand-900/30">
          <PlaneIcon />
        </div>
...
function CogIcon({ className = "h-4 w-4" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
